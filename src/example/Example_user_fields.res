...
module Value = {
  ...
  let empty = {
    ...
    mainAddress: None,
    addresses: list{},
    metadata: Belt.Map.String.fromArray([
      ("option1", Metadata.Value.empty),
      ("option2", Metadata.Value.empty),
    ]),
  }
}
...
type fields<'t, 'self> = {
  ...
  metadata: (
    Field.t<'t, Belt.Map.String.t<Metadata.Value.t>>,
    string => Metadata.fields<'t, Metadata.Value.t>,
  ),
}
  ...
  open Field
  {
    ...
    username: \"+|>"(
      ...
      Field.createField(
        ...
        ~setValue=(username, v) => {...v, username: username},
      ),
    ),
    lastname: \"+|>"(
      baseField,
      Field.createField(
        ...
        ~setValue=(lastname, v) => {...v, lastname: lastname},
      ),
    ),
    firstname: \"+|>"(
      baseField,
      Field.createField(
        ...
        ~setValue=(firstname, v) => {...v, firstname: firstname},
      ),
    ),
    gender: \"+|>"(
      baseField,
      Field.createField(
        ...
        ~setValue=(gender, v) => {...v, gender: gender},
      ),
    ),
    age: \"+|>"(
      baseField,
    ...
    mainAddress: {
      let field = \"+|>"(
        ...
        createField(
          ...
          ~setValue=(mainAddress, v) => {...v, mainAddress: mainAddress},
        ),
      )
    ...
    addresses: \"+|>"(
      ...
      createField(
        ...
        ~setValue=(addresses, v) => {...v, addresses: addresses},
      ),
    ...
    metadata: \"+|>"(
      ...
      createField(
        ...
        ~setValue=(metadata, v) => {...v, metadata: metadata},
      ),
